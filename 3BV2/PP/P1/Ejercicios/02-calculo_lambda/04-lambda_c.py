...
"""
En resumen, el código utiliza las funciones filter y lambda para separar 
la lista original de números en dos nuevas listas: 
una lista que contiene solo números pares 
y otra que contiene solo números impares.
"""