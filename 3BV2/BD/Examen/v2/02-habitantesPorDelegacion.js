...
const stream = fs.createReadStream('./archivos/datasets/inegi/poblacion-por-delegacion.csv');
...
let csvStream = fastcsv.parse()
    ...
    .on('end', async () => {
        ...
        await csv6.toDisk(`${mainPath}tbl002_poblacion_por_delegacion.csv`);
        console.log('tbl002_poblacion_por_delegacion.csv creado');
