...
const { obtenerIDDelegacion } = require('./helper-delegaciones-improved');
...
let csvStream = fastcsv.parse()
    ...
    .on('end', async () => {
        ...
        await csvVivienda.toDisk('./cleanFilesImproved/t_delegacion_ocupantes_por_vivienda.csv');
        ...
        await csvCuarto.toDisk('./cleanFilesImproved/t_delegacion_ocupantes_por_cuarto.csv');
